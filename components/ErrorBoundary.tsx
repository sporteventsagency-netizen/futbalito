...
// FIX: Refactored to use React.PropsWithChildren to correctly type props including children.
// This resolves an issue where `this.props` was not being found on the component instance type.
